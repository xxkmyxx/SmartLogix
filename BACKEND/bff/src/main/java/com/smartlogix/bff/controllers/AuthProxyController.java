...
@RestController
@Tag(name = "Auth Proxy", description = "Redirige al microservicio de autenticación")
public class AuthProxyController {
    ...
    @CircuitBreaker(name = "auth", fallbackMethod = "servicioNoDisponible")
    @RequestMapping(value = {"/api/auth", "/api/auth/**", "/api/usuarios", "/api/usuarios/**"})
    @Operation(summary = "Proxy hacia microservicio Auth")
    ...
    public ResponseEntity<String> servicioNoDisponible(HttpServletRequest request,
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                ...
                .body("{\"error\": \"Servicio de autenticación no disponible\"}");
    }
